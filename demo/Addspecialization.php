...
if(!isset($_SESSION['un'])){
  $_SESSION['sess2']="PLEASE LOGIN FIRST..!!";
  ?>
  <script>
        ...
        <section class="row">   
          <div class="col-md-12">
            <table align="center" style="margin-left: 200px;">
              <form method="post" action="insertspecialization.php" enctype="multipart/form-data">
                      ...
                      <div class="card card-primary">
                        ...
                        <div class="card-body">
                          <div class="form-group">
                            <label for="inputName">Specialization Name</label>
                            <input type="text" name="Specialization" id="inputName" class="form-control" required="required">
                          </div>
                        </div>
                         <div class="card-body">
                          <div class="form-group">
                            <label for="inputName">About</label>
                            <input type="text" name="about" id="about" class="form-control" required="required">
                          </div>
                        </div>
                         <div class="card-body">
                          <div class="form-group">
                        ...
                        <div class="row">
                          <div class="col-12">
                            <input type="submit" value="Add Specialization" name="submit" class="btn btn-success float-right">
                          </div>
                        </div>
                      </section>
                    </form>
