...
if(!isset($_SESSION['un'])){
  $_SESSION['sess8']="please login first..!!";
  ?>
  <script>
  ...
  <div id="app">
    ...
    <div id="main">
      ...
      <table border="2" class="table table-bordered">
        ...
        <thead>
          <th colspan="9" style="text-align: center;font-size: 30px;">Specialization Details</th>
          <tr style="font-size: 25px;">
           <th style="text-align: center;">Specialization Name</th>
       ...
       while($data=mysqli_fetch_assoc($execute))
       {
        ...
        <tbody>
          <tr>
            <td style="text-align: center;"><?php echo $data['Specialization'];?></td>
            <td style="text-align: center;"><?php echo $data['About'];?></td>
            <td style="text-align: center;"><img style="height: 100px;width: 100px" src="<?php echo $data['icon'];?>"></td>
            <td style="text-align: center;"><img style="height: 100px;width: 100px" src="<?php echo $data['image'];?>"></td>
            
            <td style="text-align:center;">
              <a href="editspecializattion.php?DoctorSpecialicationID=<?php echo $data['DoctorSpecialicationID']; ?>"   class="edit_btn" >
                <li class="list-inline-item">
                 <button class="btn btn-success btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></button> </li></a>
                 <a href="deletespecialization.php?DoctorSpecialicationID=<?php echo $data['DoctorSpecialicationID']; ?>" onclick="return confirmation()" class="del_btn" >
                  <li class="list-inline-item">
                    <button class="btn btn-danger btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></button></li></a>
                  </td>
